...
class Atri:
	def __init__(self, state: Any):
		...
		self.PrevBtn = state["PrevBtn"]
		self.NextBtn = state["NextBtn"]
		self.Flex61 = state["Flex61"]
		self.Carousel = state["Carousel"]
	...
	@property
	def PrevBtn(self):
		self._getter_access_tracker["PrevBtn"] = {}
		return self._PrevBtn
	@PrevBtn.setter
	def PrevBtn(self, new_state):
		self._setter_access_tracker["PrevBtn"] = {}
		global default_state
		self._PrevBtn = Div(new_state, default_state["PrevBtn"])

	@property
	def NextBtn(self):
		self._getter_access_tracker["NextBtn"] = {}
		return self._NextBtn
	@NextBtn.setter
	def NextBtn(self, new_state):
		self._setter_access_tracker["NextBtn"] = {}
		global default_state
		self._NextBtn = Div(new_state, default_state["NextBtn"])
	...
	@property
	def Carousel(self):
		self._getter_access_tracker["Carousel"] = {}
		return self._Carousel
	@Carousel.setter
	def Carousel(self, new_state):
		self._setter_access_tracker["Carousel"] = {}
		global default_state
		self._Carousel = Flex(new_state, default_state["Carousel"])
	...
	def _to_json_fields(self):
		return {
			...
			"Flex53": self._Flex53,
			"Flex56": self._Flex56,
			"PrevBtn": self._PrevBtn,
			"NextBtn": self._NextBtn,
			"Flex61": self._Flex61,
